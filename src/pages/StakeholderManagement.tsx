    ...
    return (
        <Layout title="Stakeholder Management">
            <div className="flex flex-col gap-6 max-w-[1400px] mx-auto pb-20">
                {/* Header Section */}
                <div className="flex items-center justify-between bg-primary p-4 rounded-t-lg shadow-lg border-b-4 border-secondary">
                    ...
                    <Dialog open={isAddDialogOpen} onOpenChange={(open) => {
                        ...
                        <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden border-none rounded-xl">
